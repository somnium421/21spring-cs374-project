...
$(document).ready(() => {
    if (isAssign){
        ...
        OrgChart.templates.family_template.img = '<clipPath id="{randId}"><circle cx="21.5" cy="21.5" r="18"></circle></clipPath></circle><image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="3" y="3"  width="40" height="40" opacity="0.3"></image>';
        OrgChart.templates.family_template.node = '<circle stroke-width="2" fill="none" stroke="#aeaeae" cx="21.5" cy="21.5" r="20"></circle>';
        ...
        OrgChart.templates.family_template_blue.img = '<clipPath id="{randId}"><circle cx="21.5" cy="21.5" r="18"></circle></clipPath></circle><image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="3" y="3"  width="40" height="40" opacity="1"></image>';
